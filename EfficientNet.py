...
# Define the path to save the model (updated as per your request)
save_dir = 'D:/Btech_project/Covid/EfficientNet'
...
# Set image size for EfficientNetB0 (224x224)
img_size = (224, 224)
...
model = create_efficientnet_model((img_size[0], img_size[1], 3), num_classes)
...
# Set up callbacks
checkpoint_path = os.path.join(save_dir, 'efficientnet_best_model.keras')
...
final_model_path = os.path.join(save_dir, 'efficientnet_final_model.keras')
try:
