...
save_dir = 'D:/Btech_project/Covid/xception'  # Updated to save to the correct directory
...
# Set image size for Xception (default is 299x299)
img_size = (299, 299)
...
model = create_xception_model((img_size[0], img_size[1], 3), num_classes)
...
# Set up callbacks
checkpoint_path = os.path.join(save_dir, 'xception_best_model.keras')
...
final_model_path = os.path.join(save_dir, 'xception_final_model.keras')
try:
