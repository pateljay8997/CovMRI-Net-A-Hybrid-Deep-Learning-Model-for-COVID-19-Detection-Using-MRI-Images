...
def find_model_file(directory='D:/Btech_project/Covid/resnet50'):
...
results_dir = 'D:/Btech_project/Covid/resnet50/evaluation_results'
...
generator = datagen.flow_from_dataframe(
    ...
    x_col='filename',
    y_col='class',
    target_size=(224, 224),  # Use (224, 224) for ResNet50 model
    batch_size=32,
